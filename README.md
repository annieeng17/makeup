...
- Just press ctrl B when you open main.py

# Which libraries you're using that need to be installed.

- - What you need to do in order for this application to work. You most 
imperatively need to have openCV perfectly working and download all the other 
files attached. Lastly, there are no shortcut commands
